...
class ConfigRepo {
  ...
  static const String enableCloudMessageSearch = 'enable_cloud_message_search';

  static const String enableAIStream = 'enable_ai_stream';

  static const String enableSafetyNotice = 'enable_safety_notice';
  ...
  /// 获取是否打开云端消息搜索
  static Future<bool> getEnableCloudMessageSearch() async {
    return await PreferenceUtils.getBool(enableCloudMessageSearch, false);
  }

  /// 设置是否打开云端消息搜索
  static void updateEnableCloudMessageSearch(bool enable) {
    PreferenceUtils.saveBool(enableCloudMessageSearch, enable);
  }
