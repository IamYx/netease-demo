...
class IMKitClient {
  ...
  static bool? _enableCloudMessageSearch;
  ...
  /// 设置是否打开云端消息搜索
  static void setEnableCloudMessageSearch(bool enable) {
    _enableCloudMessageSearch = enable;
    return ConfigRepo.updateEnableCloudMessageSearch(enable);
  }

  /// 是否打开云端消息搜索
  static Future<bool> get enableCloudMessageSearch async {
    if (_enableCloudMessageSearch != null) {
      return _enableCloudMessageSearch!;
    }

    _enableCloudMessageSearch = await ConfigRepo.getEnableCloudMessageSearch();
    return _enableCloudMessageSearch!;
  }

  ///同步返回的是否支持云端消息搜索
  static bool? isEnableCloudMessageSearch() {
    return _enableCloudMessageSearch;
  }

  static bool? _enableAIStream;

  static bool? _enableSafetyTips;

  /// 设置是否打开安全文案提醒
  /// 在本身没有UI开关的情况下，可以在初始化前调用此方法设置
  static void setEnableSafetyTips(bool enable) {
    _enableSafetyTips = enable;
    return ConfigRepo.updateEnableSafetyTips(enable);
  }

  /// 是否打开安全文案提醒
  static Future<bool> get enableSafetyTips async {
    if (_enableSafetyTips != null) {
      return _enableSafetyTips!;
    }
    _enableSafetyTips = await ConfigRepo.getEnableSafetyTips();
    return _enableSafetyTips!;
  }

  ///同步返回的是否支持安全文案提醒
  static bool? isEnableSafetyTips() {
    return _enableSafetyTips;
  }
