 ...
 * @endif
 */
- (int)startBlendExternalVideo:(NERtcStreamChannelType)streamType blendConfig:(NERtcVideoExternalBlendConfig *)blendConfig;
 ...
 * @endif
 */
- (int)pushBlendExternalVideoFrame:(NERtcStreamChannelType)streamType frame:(NERtcVideoFrame *)frame;
