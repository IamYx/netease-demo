...
static NSString *kYXPrivatePolicyURL_EN = @"https://commsease.com/en/clauses?serviceType=3";
// 用户协议URL
static NSString *kYXUserAgreementURL = @"http://yunxin.163.com/clauses";

static NSString *kYXUserAgreementURL_EN = @"https://commsease.com/en/clauses?serviceType=0";
